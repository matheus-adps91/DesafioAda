...
public class ResponseConversor {
    ...
    public PessoaFisicaResponse converterParaResponse(PessoaFisica pessoaSalva)
    {
        ...
        if (mapaPropriedade == null) {
            final TypeMap<PessoaFisica, PessoaFisicaResponse> propertyMap = this.mapper.createTypeMap(PessoaFisica.class, PessoaFisicaResponse.class);
    ...
    public PessoaJuridicaResponse converterParaResponse(PessoaJuridica pessoaSalva)
    {
        ...
        if (mapaPropriedade == null) {
            final TypeMap<PessoaJuridica, PessoaJuridicaResponse> novoMapaPropriedade = this.mapper.createTypeMap(PessoaJuridica.class, PessoaJuridicaResponse.class);
